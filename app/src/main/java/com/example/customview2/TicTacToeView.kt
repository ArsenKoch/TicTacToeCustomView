...
class TicTacToeView(
    ...
    private fun initAttributes(attributesSet: AttributeSet?, defStyleAttr: Int, defStyleRes: Int) {
        ...
        player1Color =
            typedArray.getColor(R.styleable.TicTacToeView_playerColor1, PLAYER1_DEFAULT_COLOR)
        player2Color =
            typedArray.getColor(R.styleable.TicTacToeView_playerColor2, PLAYER2_DEFAULT_COLOR)
