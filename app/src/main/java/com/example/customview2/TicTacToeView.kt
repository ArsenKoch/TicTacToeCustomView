...
class TicTacToeView(
    ...
    private fun initAttributes(attributeSet: AttributeSet?,defStyleAttr: Int,defStyleRes: Int){
        val typedArray = context.obtainStyledAttributes(attributeSet,R.styleable.TicTacToeView,
           defStyleAttr, defStyleRes)
        playerColor1 = typedArray.getColor(R.styleable.TicTacToeView_playerColor1,
            PLAYER1_DEFAULT_COLOR)
        playerColor2 = typedArray.getColor(R.styleable.TicTacToeView_playerColor2,
